...
//
//    private List<Video> videoInfoList = new ArrayList<>();
...
//        if (uriString != null) {
//            MediaSource videoSource = new HlsMediaSource.Factory(
...
//                    PlayerView plv = view.findViewById(R.id.videoPlayer);
//                    Player tempPlayer = plv.getPlayer();
//                    if(tempPlayer!=null) pausePlayer(tempPlayer);
...
//    }
//
//    private void startPlayer(Player playerForItem){
//        if(playerForItem!=null) {
